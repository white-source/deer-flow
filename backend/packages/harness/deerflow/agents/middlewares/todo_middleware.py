...
class TodoMiddlewareState(ThreadState):
    """Reuse thread state so todos keeps merge_todos reducer."""
...
class TodoMiddleware(TodoListMiddleware):
    ...
    state_schema = TodoMiddlewareState  # type: ignore[assignment]

    @override
    def before_model(
        self,
        state: TodoMiddlewareState,
        runtime: Runtime,
    ) -> dict[str, Any] | None:
    ...
    @override
    def before_agent(self, state: TodoMiddlewareState, runtime: Runtime) -> dict[str, Any] | None:
        self._clear_other_run_completion_reminders(runtime)
        return None

    @override
    async def abefore_agent(self, state: TodoMiddlewareState, runtime: Runtime) -> dict[str, Any] | None:
        self._clear_other_run_completion_reminders(runtime)
        return None
    ...
    @override
    def after_agent(self, state: TodoMiddlewareState, runtime: Runtime) -> dict[str, Any] | None:
        self._clear_current_run_completion_reminders(runtime)
        return None

    @override
    async def aafter_agent(self, state: TodoMiddlewareState, runtime: Runtime) -> dict[str, Any] | None:
        self._clear_current_run_completion_reminders(runtime)
        return None
